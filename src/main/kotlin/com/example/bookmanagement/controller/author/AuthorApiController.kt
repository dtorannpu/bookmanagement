...
class AuthorApiController(private val authorService: AuthorService) : AuthorsApi {
    override fun createAuthor(createAuthorRequest: CreateAuthorRequest): ResponseEntity<Unit> {
        authorService.create(createAuthorRequest.name, createAuthorRequest.birthday)
        return ResponseEntity(HttpStatus.OK)
    }

    override fun updateAuthor(updateAuthorRequest: UpdateAuthorRequest): ResponseEntity<Unit> {
